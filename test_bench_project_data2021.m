...
TestCases = ["Static", "QStatic", "Varying"];
SNRs      = ["Low", "High"];
    ...
    for SNR = SNRs
        ...
        switch TestCase
            case 'Static'
                ...
                plot(squared_e);
                title(strcat("Static: e^2 (",SNR," SNR)"));
            case 'QStatic'
                ...
                plot(avg_squared_e);
                title(strcat("Quasi-static: e^2 (",SNR," SNR, averaged over ",num2str(Pa.Q_Static.NumRepetition)," train seq)"));
            case 'Varying'
                ...
                plot(avg_squared_e);        
                title(strcat("Time-varying: e^2 (",SNR," SNR, averaged over ",num2str(Pa.T_Varying.NumRepetition)," train seq)"));
        end
